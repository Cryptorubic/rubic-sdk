...
export declare class TokensManager {
    ...
    createPriceTokenAmount(priceTokenAmountStruct: PriceTokenAmountBaseStruct | Parameters<typeof PriceTokenAmount.createFromToken>[number]): Promise<PriceTokenAmount>;
}
