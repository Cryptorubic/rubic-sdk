            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        _d = (_c = Promise).all;
                        _e = [web3Public.getEstimatedGas(cross_chain_contract_abi_1.crossChainContractAbi, contractAddress, methodName, methodArguments, walletAddress, value)];
    ...
    CrossChainTrade.prototype.getContractParams = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                methodArguments = fromTrade.getMethodArguments(toTrade, this.walletAddress);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, injector_1.Injector.web3Private.tryExecuteContractMethod(contractAddress, cross_chain_contract_abi_1.crossChainContractAbi, methodName, methodArguments, {
