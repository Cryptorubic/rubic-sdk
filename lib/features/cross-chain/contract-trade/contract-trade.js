...
var ContractTrade = /** @class */ (function () {
    ...
    ContractTrade.prototype.getMethodArguments = function (toContractTrade, walletAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenInAmountAbsolute, tokenOutAmountMinAbsolute, fromTransitTokenAmountMinAbsolute, toNumOfBlockchain, firstPath, secondPath, swapToUserMethodSignature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, toContractTrade.contract.getNumOfBlockchain()];
                    case 1:
