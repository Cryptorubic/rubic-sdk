...
var OneinchTrade = /** @class */ (function (_super) {
    ...
    OneinchTrade.oneInchTradeTypes = (_a = {},
        _a[core_1.BLOCKCHAIN_NAME.ETHEREUM] = trade_type_1.TRADE_TYPE.ONE_INCH_ETHEREUM,
        _a[core_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN] = trade_type_1.TRADE_TYPE.ONE_INCH_BSC,
        _a[core_1.BLOCKCHAIN_NAME.POLYGON] = trade_type_1.TRADE_TYPE.ONE_INCH_POLYGON,
        _a);
    __decorate([
        common_1.Cache
