...
var QuickSwapTrade = /** @class */ (function (_super) {
    __extends(QuickSwapTrade, _super);
    function QuickSwapTrade(tradeStruct) {
        var _this = _super.call(this, tradeStruct) || this;
        _this.contractAddress = constants_1.QUICK_SWAP_CONTRACT_ADDRESS;
        return _this;
    }
    Object.defineProperty(QuickSwapTrade, "type", {
        get: function () {
            return features_1.TRADE_TYPE.QUICK_SWAP;
        },
        enumerable: false,
        configurable: true
    });
    return QuickSwapTrade;
