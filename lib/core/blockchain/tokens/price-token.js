            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        pricePromise = coingeckoApi.getTokenPrice(tokenBaseStruct);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        coingeckoApi = injector_1.Injector.coingeckoApi;
                        return [4 /*yield*/, coingeckoApi.getTokenPrice(token)];
                    case 1:
                        price = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        coingeckoApi = injector_1.Injector.coingeckoApi;
                        _a = this;
                        return [4 /*yield*/, coingeckoApi.getTokenPrice(__assign({}, this))];
                    case 1:
                        _a._price = _b.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        coingeckoApi = injector_1.Injector.coingeckoApi;
                        return [4 /*yield*/, coingeckoApi.getTokenPrice(this)];
                    case 1:
                        price = _a.sent();
