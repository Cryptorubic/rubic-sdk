export const feelibraryabi = [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'priceSD', type: 'uint256' },
            {
                indexed: false,
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_amountSD', type: 'uint256' },
            { internalType: 'uint256', name: '_protocolSubsidy', type: 'uint256' },
            { internalType: 'bool', name: '_whitelisted', type: 'bool' },
            { internalType: 'bool', name: '_hasEqReward', type: 'bool' }
        ],
    ...
    {
        inputs: [
            { internalType: 'uint256', name: '_poolId1', type: 'uint256' },
            { internalType: 'uint256', name: '_poolId2', type: 'uint256' }
        ],
        name: 'isSameToken',
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: 'basePriceSD', type: 'uint256' },
            { internalType: 'uint256', name: 'currentPriceSD', type: 'uint256' },
            {
                internalType: 'enum StargateFeeLibraryV05.PriceDeviationState',
                name: 'state',
                type: 'uint8'
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_lpId', type: 'uint256' }
        ],
        name: 'setPoolToLpId',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    },
    {
        inputs: [
            { internalType: 'uint256', name: '_poolId1', type: 'uint256' },
            { internalType: 'uint256', name: '_poolId2', type: 'uint256' },
            { internalType: 'bool', name: '_isSame', type: 'bool' }
        ],
        name: 'setSameToken',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    },
    {
        inputs: [
            { internalType: 'uint256', name: '_poolId', type: 'uint256' },
            { internalType: 'uint256', name: '_basePriceSD', type: 'uint256' }
        ],
