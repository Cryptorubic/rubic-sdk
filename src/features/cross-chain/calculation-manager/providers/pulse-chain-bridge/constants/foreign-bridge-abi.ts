...
export const foreignBridgeAbi: AbiItem[] = [
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_requestGasLimit', type: 'uint256' },
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint256', name: '_minCashThreshold', type: 'uint256' }
        ],
    ...
    },
    {
        ...
        outputs: [{ internalType: 'contract IInterestImplementation', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function'
    },
    {
