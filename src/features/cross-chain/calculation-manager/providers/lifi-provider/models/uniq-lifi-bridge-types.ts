...
import { LIFI_API_CROSS_CHAIN_PROVIDERS } from 'src/features/cross-chain/calculation-manager/providers/lifi-provider/models/lifi-bridge-types';
...
export const UNIQ_LIFI_BRIDGE_TYPES = {
    ...
    LI_FUEL: LIFI_API_CROSS_CHAIN_PROVIDERS.LI_FUEL,
