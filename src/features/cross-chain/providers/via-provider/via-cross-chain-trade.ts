...
import {
    viaContractAbi,
    viaContractAddress
} from 'src/features/cross-chain/providers/via-provider/constants/contract-data';
...
import { ViaCrossChainSupportedBlockchain } from 'src/features/cross-chain/providers/via-provider/constants/via-cross-chain-supported-blockchain';
