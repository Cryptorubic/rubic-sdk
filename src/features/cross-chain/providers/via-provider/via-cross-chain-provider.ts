...
import { viaContractAddress } from 'src/features/cross-chain/providers/via-provider/constants/contract-data';
...
export class ViaCrossChainProvider extends CrossChainProvider {
    ...
    public isSupportedBlockchains(
        ...
        return (
            ViaCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
            ViaCrossChainProvider.isSupportedBlockchain(toBlockchain)
        );
    }
