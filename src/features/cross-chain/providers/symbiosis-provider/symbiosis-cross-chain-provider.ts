...
} from 'src/features/cross-chain/providers/symbiosis-provider/constants/symbiosis-cross-chain-supported-blockchain';
import {
    ErrorCode,
    Symbiosis,
...
export class SymbiosisCrossChainProvider extends CrossChainProvider {
    ...
    public isSupportedBlockchains(
        ...
        return (
            SymbiosisCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
            SymbiosisCrossChainProvider.isSupportedBlockchain(toBlockchain)
        );
    }
