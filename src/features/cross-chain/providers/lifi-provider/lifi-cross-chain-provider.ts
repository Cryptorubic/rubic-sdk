import { getLifiConfig } from 'src/features/cross-chain/providers/lifi-provider/constants/lifi-config';
...
} from 'src/features/cross-chain/providers/lifi-provider/constants/lifi-cross-chain-supported-blockchain';
...
import { lifiContractAddress } from 'src/features/cross-chain/providers/lifi-provider/constants/lifi-contract-data';
...
export class LifiCrossChainProvider extends CrossChainProvider {
    ...
    public isSupportedBlockchains(
        ...
        return (
            LifiCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
            LifiCrossChainProvider.isSupportedBlockchain(toBlockchain)
        );
    }
