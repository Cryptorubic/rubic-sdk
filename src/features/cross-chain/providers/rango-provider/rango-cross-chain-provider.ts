...
} from 'src/features/cross-chain/providers/rango-provider/constants/rango-cross-chain-supported-blockchain';
...
import { RANGO_BLOCKCHAIN_NAME } from 'src/features/cross-chain/providers/rango-provider/constants/rango-blockchain-name';
import { RANGO_CONTRACT_ADDRESSES } from 'src/features/cross-chain/providers/rango-provider/constants/contract-address';
import { PriceToken, PriceTokenAmount } from 'src/common/tokens';
import { BridgeType } from 'src/features/cross-chain/providers/common/models/bridge-type';
import { rangoProviders } from 'src/features/cross-chain/providers/rango-provider/constants/rango-providers';
import { RANGO_TRADE_BRIDGE_TYPE } from 'src/features/cross-chain/providers/rango-provider/models/rango-providers';
...
export class RangoCrossChainProvider extends CrossChainProvider {
    ...
    public isSupportedBlockchains(
        ...
        return (
            RangoCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
            RangoCrossChainProvider.isSupportedBlockchain(toBlockchain)
        );
    }
