...
} from 'src/features/cross-chain/providers/celer-provider/models/celer-cross-chain-supported-blockchain';
import { OnChainCalculatedTrade } from 'src/features/cross-chain/providers/celer-provider/models/on-chain-calculated-trade';
...
import { CelerDirectContractTrade } from 'src/features/cross-chain/providers/celer-provider/celer-contract-trade/celer-direct-contract-trade/celer-direct-contract-trade';
import {
...
import { EstimateAmtResponse } from 'src/features/cross-chain/providers/celer-provider/models/estimate-amount-response';
import { Web3Pure } from 'src/core/blockchain/web3-pure/web3-pure';
import { getCelerCrossChainContract } from 'src/features/cross-chain/providers/celer-provider/constants/celer-cross-chain-contracts';
...
import { CelerOnChainContractTrade } from 'src/features/cross-chain/providers/celer-provider/celer-contract-trade/celer-on-chain-contract-trade/celer-on-chain-contract-trade';
...
import { MinMaxAmounts } from 'src/features/cross-chain/providers/celer-provider/models/min-max-amounts';
...
export class CelerCrossChainProvider extends CrossChainProvider {
    ...
    public isSupportedBlockchains(
        ...
        return (
            CelerCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
            CelerCrossChainProvider.isSupportedBlockchain(toBlockchain)
        );
    }
