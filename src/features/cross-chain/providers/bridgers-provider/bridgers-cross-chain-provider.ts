...
} from 'src/features/cross-chain/providers/bridgers-provider/constants/bridgers-cross-chain-supported-blockchain';
...
import { EvmBridgersCrossChainTrade } from 'src/features/cross-chain/providers/bridgers-provider/evm-bridgers-trade/evm-bridgers-cross-chain-trade';
    ...
    public isSupportedBlockchains(
        ...
        return (
            (fromBlockchain === BLOCKCHAIN_NAME.TRON &&
                BridgersCrossChainProvider.isSupportedBlockchain(toBlockchain)) ||
            (BridgersCrossChainProvider.isSupportedBlockchain(fromBlockchain) &&
