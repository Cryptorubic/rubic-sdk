...
const defaultPegasysRoutingProvidersAddresses = [
...
const defaultPegasysWethAddress = wrappedNativeTokensList[BLOCKCHAIN_NAME.SYSCOIN].address;

export const defaultSyscoinProviderConfiguration: UniswapV2ProviderConfiguration = {
    maxTransitTokens: 2,
    routingProvidersAddresses: defaultPegasysRoutingProvidersAddresses,
    wethAddress: defaultPegasysWethAddress
};
