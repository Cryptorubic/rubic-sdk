...
export const UNI_SWAP_V3_PULSECHAIN_PROVIDER_CONFIGURATION: UniswapV3AlgebraProviderConfiguration =
    {
        wethAddress: wrappedNativeTokensList[BLOCKCHAIN_NAME.PULSECHAIN]!.address,
        maxTransitTokens: 1
    };
