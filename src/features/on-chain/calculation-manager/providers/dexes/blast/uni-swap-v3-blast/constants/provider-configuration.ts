...
export const UNI_SWAP_V3_BLAST_PROVIDER_CONFIGURATION: UniswapV3AlgebraProviderConfiguration = {
    wethAddress: wrappedNativeTokensList[BLOCKCHAIN_NAME.BLAST]!.address,
    maxTransitTokens: 1
};
