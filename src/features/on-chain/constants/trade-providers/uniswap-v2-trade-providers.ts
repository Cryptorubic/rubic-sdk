...
import { SushiSwapEthereumProvider } from 'src/features/on-chain/providers/dexes/ethereum/sushi-swap-ethereum/sushi-swap-ethereum-provider';
...
import { QuickSwapProvider } from 'src/features/on-chain/providers/dexes/polygon/quick-swap/quick-swap-provider';
import { SushiSwapPolygonProvider } from 'src/features/on-chain/providers/dexes/polygon/sushi-swap-polygon/sushi-swap-polygon-provider';
...
import { SpookySwapProvider } from 'src/features/on-chain/providers/dexes/fantom/spooky-swap/spooky-swap-provider';
...
import { ViperSwapHarmonyProvider } from 'src/features/on-chain/providers/dexes/harmony/viper-swap-harmony/viper-swap-harmony-provider';
import { SushiSwapArbitrumProvider } from 'src/features/on-chain/providers/dexes/arbitrum/sushi-swap-arbitrum/sushi-swap-arbitrum-provider';
...
import { TrisolarisAuroraProvider } from 'src/features/on-chain/providers/dexes/aurora/trisolaris-aurora/trisolaris-aurora-provider';
import { WannaSwapAuroraProvider } from 'src/features/on-chain/providers/dexes/aurora/wanna-swap-aurora/wanna-swap-aurora-provider';
import { SushiSwapTelosProvider } from 'src/features/on-chain/providers/dexes/telos/sushi-swap-telos/sushi-swap-telos-provider';
import { ZappyProvider } from 'src/features/on-chain/providers/dexes/telos/zappy/trisolaris-aurora-provider';
import { OolongSwapProvider } from 'src/features/on-chain/providers/dexes/boba/oolong-swap/oolong-swap-provider';
import { UniSwapV2EthereumPowProvider } from 'src/features/on-chain/providers/dexes/ethereum-pow/uni-swap-v2-ethereum-pow/uni-swap-v2-ethereum-pow-provider';

import { SushiSwapEthereumPowProvider } from 'src/features/on-chain/providers/dexes/ethereum-pow/sushi-swap-ethereum-pow/sushi-swap-ethereum-pow-provider';
