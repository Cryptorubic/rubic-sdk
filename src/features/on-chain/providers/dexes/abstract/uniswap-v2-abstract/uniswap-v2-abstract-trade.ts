import { DefaultEstimatedGas } from 'src/features/on-chain/providers/dexes/abstract/uniswap-v2-abstract/models/default-estimated-gas';
import { createTokenNativeAddressProxyInPathStartAndEnd } from 'src/features/on-chain/providers/dexes/abstract/utils/token-native-address-proxy';
...
import { defaultEstimatedGas } from 'src/features/on-chain/providers/dexes/abstract/uniswap-v2-abstract/constants/default-estimated-gas';
...
import {
    ...
    SWAP_METHOD
} from 'src/features/on-chain/providers/dexes/abstract/uniswap-v2-abstract/constants/SWAP_METHOD';
...
import { defaultUniswapV2Abi } from 'src/features/on-chain/providers/dexes/abstract/uniswap-v2-abstract/constants/uniswap-v2-abi';
