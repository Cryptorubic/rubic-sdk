...
import { RouterSendTransactionParams, RouterSendTransactionResponse } from "../models/router-send-transaction-params";


export class RouterApiService {
    private static readonly ROUTER_ENDPOINT = 'https://api-beta.pathfinder.routerprotocol.com/api/v2';
    ...
    public static async getQuote(
        ...
        return Injector.httpClient.get<RouterQuoteResponseConfig>(
            `${this.ROUTER_ENDPOINT}/quote`, {
