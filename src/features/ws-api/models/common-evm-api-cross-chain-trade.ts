...
import { CommonEvmApiCrossChainConstructor } from 'src/features/ws-api/models/common-evm-api-cross-chain-constructor';

export class CommonEvmApiCrossChainTrade extends EvmCrossChainTrade {
    ...
    constructor(params: CommonEvmApiCrossChainConstructor) {
