...
import { SUSHI_SWAP_PROVIDER_CONFIGURATION } from '@features/swap/providers/ethereum/sushi-swap-ethereum/constants';
...
export class SushiSwapEthereumProvider extends UniswapV2AbstractProvider<SushiSwapEthereumTrade> {
    ...
    public readonly providerSettings = SUSHI_SWAP_PROVIDER_CONFIGURATION;
}
