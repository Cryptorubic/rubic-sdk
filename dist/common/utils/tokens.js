...
function getPriceTokensFromInputTokens(from, fromAmount, to) {
    return __awaiter(this, void 0, void 0, function () {
        var fromPriceTokenPromise, toPriceTokenPromise, _a, fromPriceToken, toPriceToken, fromPriceTokenAmount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), fromPriceToken = _a[0], toPriceToken = _a[1];
                    fromPriceTokenAmount = new price_token_amount_1.PriceTokenAmount(__assign(__assign({}, fromPriceToken.asStruct), { tokenAmount: new bignumber_js_1.default(fromAmount) }));
                    return [2 /*return*/, {
