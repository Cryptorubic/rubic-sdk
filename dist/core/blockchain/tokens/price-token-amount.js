...
var PriceTokenAmount = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [2 /*return*/, new PriceTokenAmount(__assign(__assign({}, token.asStruct), { weiAmount: tokenAmountBaseStruct.weiAmount }))];
                }
            });
        });
    };
    ...
    PriceTokenAmount.prototype.calculatePriceImpact = function (toToken) {
        var _a, _b;
        if (!this.price ||
            !toToken.price ||
